...
import meow from '../data/meow.jpg';
...
const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
  <TooltipComponent content={title} position="BottomCenter">
    ...
    className="relative text-xl rounded-full p-3 hover:bg-light-gray dark:hover:bg-slate-400"
    >
  ...
  return (
    <div className="flex justify-between p-2 md:mx-6 relative">
      ...
      <div className="flex">
        ...
        >
          <div className=" flex items-center gap-2 cursur-pointer p-1 hover:bg-light-gray  rounded-lg" onClick={() => handleClick('userProfile')}>
            <img 
